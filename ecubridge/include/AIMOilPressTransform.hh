#ifndef AIMOILPRESSTRANSFORM_HH
#define AIMOILPRESSTRANSFORM_HH

#include "DataTransformer.hh"

class AIMOilPressTransform : public DataTransformer {
